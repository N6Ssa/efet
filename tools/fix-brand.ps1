...
while($stack.Count -gt 0){
  ...
  # remove ONLY near-white background, keep glyph anti-aliasing intact
  if(-not ($lum -gt 228 -and $sat -lt 16)){ continue }
...
$crop.Save('C:\Users\Pasha\efet-studio\assets\hero\metal\brand-mark.png')
$crop.Dispose()
$src.Dispose()
Write-Output 'BRAND OK'
